(function () {
    ...
    "generator","Refrigerator and Dispenser","Plumbing"];
        $scope.selected = [];
        $http.post('http://50.62.160.125/api/feature/view/', 0)
        ...
        $scope.save = function () {
            ...
            $scope.message = $http.post('http://50.62.160.125/api/service/create/', $scope.service).
                then(function (response) {
    ...
    app.controller("updateService", function ($scope, $http, $log, $rootScope, $location) {
        ...
        $http.post('http://50.62.160.125/api/service/view/', $rootScope.serviceId)
            .then(function (response) {
        ...
        $scope.update = function () {
            $scope.service.features=$scope.selected;
            console.log($scope.service);
            $http.post('http://50.62.160.125/api/service/edit/', $scope.service)
                .then(function (response) {
