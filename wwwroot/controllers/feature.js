(function() {
    ...
    app.controller("featureController", function($scope, $http, $rootScope, close, ModalService, NgMap) {
        ...
        $scope
            .$watch("date", function(newValue, oldValue) {
                if (oldValue != newValue) {
                    ...
                    $scope.message = $http
                        .post('http://localhost:5000/api/shift/getshiftfortask', $scope.shiftFilter)
                        .then(function(response) {
        ...
        $scope.message = $http
            .post('http://localhost:5000/api/service/view/', $rootScope.permService)
            .then(function(response) {
            ...
            if ($scope.counter == 4) {
                ...
                if (file != null) {
                    ...
                    reader.onload = function(e) {
                        ...
                        console.log($rootScope.task);
                        $scope.message = $http
                            .post('http://localhost:5000/api/task/create/', $scope.task)
                            .then(function(response) {
