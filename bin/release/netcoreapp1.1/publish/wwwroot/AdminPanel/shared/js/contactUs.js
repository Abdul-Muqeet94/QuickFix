...
$scope.dtOptions = DTOptionsBuilder.newOptions()
            ...
            $scope.message = $http.post('http://assany.com/api/contactus/view/', 0).
                then(function (response) {
                 ...
                 $scope.delete=function(val){
                     console.log(val);
             $scope.message = $http.post('http://assany.com/api/contactus/delete/',val).
                then(function (response) {
...
ModalService.showModal({
 ...
 app.controller("viewInnerContact", function ($scope,$route, DTOptionsBuilder,$location,$http, $rootScope, $location,$log) {
    ...
    $scope.message = $http.post('http://assany.com/api/contactus/view/', $rootScope.contactView).
                then(function (response) {
                    $scope.contacts=response.data;
