(function () {
    ...
    app.controller("addEmployeeType", function ($scope, $http, $log) {
        ...
        $scope.emp={name:""};
            ...
            $scope.message = $http.post('http://assany.com/api/employeetype/create/', $scope.emp).
    ...
    $http.post('http://assany.com/api/employeetype/view/', 0)
        .then(function (response) {
    ...
    $scope.delete = function (val) {
        ...
        $scope.message = $http.post('http://assany.com/api/employeetype/delete/', val).
            then(function (response) {
    ...
    $scope.update = function (data) {
        $scope.message = $http.post('http://assany.com/api/employee/view/', data).
            then(function (response) {
