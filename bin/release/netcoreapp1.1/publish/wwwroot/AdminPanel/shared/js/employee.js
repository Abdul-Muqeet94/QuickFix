(function () {
    ...
    app.controller("addEmployee", function ($scope, $http, $log,$location) {
        ...
        .then(function (response) {
         ...
         $http.post('http://assany.com/api/shift/view/', 0)
        .then(function (response) {
    ...
    //   };
     ...
     app.controller("updateEmployee", function ($scope, $http, $log,$rootScope,$location) {
        ...
        .then(function (response) {
          ...
          $http.post('http://assany.com/api/employee/view/', $rootScope.empid)
        .then(function (response) {
    ...
    //   };
        $scope.update=function(){
            ...
            console.log($scope.employee);
            //api/employee/edit
             $http.post('http://assany.com/api/employee/edit/', $scope.employee)
        .then(function (response) {
