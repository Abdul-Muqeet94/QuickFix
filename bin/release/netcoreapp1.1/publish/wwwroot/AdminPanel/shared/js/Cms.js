   ...
   $scope.options=["index","AC Service & Repair","CCTV Camera","Marble Tiles & Sanitary","Electrician","House Painters","Electrical Equipments Repairing","Carpenter",
    "Drilling & Hanging","Ceiling","Plumbing","Bathroom Deep Cleaning"];
        $scope.save = function () {
            ...
            $scope.message = $http.post('http://assany.com/api/cms/create/', $scope.cms).
...
$scope.dtOptions = DTOptionsBuilder.newOptions()
            ...
            $scope.message = $http.post('http://assany.com/api/cms/view/', 0).
                then(function (response) {
             ...
             $scope.message = $http.post('http://assany.com/api/cms/delete/',val).
                then(function (response) {
                    console.log(response.data);
       ...
       app.controller("updateCms", function ($scope, $http, $log,$location,$rootScope) {
         ...
         $scope.message = $http.post('http://assany.com/api/cms/view/',$rootScope.cmsId).
                then(function (response) {
                ...
                $scope.update=function(){
                    $scope.message = $http.post('http://assany.com/api/cms/edit',$scope.cms).
                then(function (response) {
