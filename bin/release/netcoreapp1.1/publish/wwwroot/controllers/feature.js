(function() {
    ...
    app.controller("featureController", function($scope, $http, $rootScope, close, ModalService, NgMap) {
        ...
        $scope
            .$watch("date", function(newValue, oldValue) {
                if (oldValue != newValue) {
                    ...
                    $scope.message = $http
                        .post('http://assany.com/api/shift/getshiftfortask', $scope.shiftFilter)
                        .then(function(response) {
        ...
        $scope.message = $http
            .post('http://assany.com/api/service/view/', $rootScope.permService)
            .then(function(response) {
            ...
            if ($scope.counter == 4) {
                ...
                if (file != null) {
                    ...
                    reader.onload = function(e) {
                        ...
                        console.log($rootScope.task);
                        $scope.message = $http
                            .post('http://assany.com/api/task/create/', $scope.task)
                            .then(function(response) {
