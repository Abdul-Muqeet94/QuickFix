...
app.controller("formController", function($scope,$http,$rootScope,$location,ModalService) {
 ...
 $scope.message = $http.post('http://assany.com/api/cms/viewbypage','"' + $rootScope.pageName + '"').
...
$scope.request=function()
{
 ...
 $scope.message = $http.post('http://assany.com/api/contactus/create/',$scope.problem).
            then(function (response) {
