(function () {
    ...
    app.controller("addTask", function ($scope, $http, $log, $location) {
        ...
        $scope.save = function () {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/employee/create/', $scope.emp).
                then(function (response) {
    ...
    app.controller("viewTask", function ($scope, DTOptionsBuilder, $http, $rootScope, $location) {
        ...
        $http.post('http://184.168.146.148:88/api/task/toassignview', 0)
            .then(function (response) {
        ...
        $scope.delete = function (val) {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/task/delete', val).
                then(function (response) {
    ...
    app.controller("assignTask", function ($scope, $http, $log, $rootScope, $route, $sce, NgMap, $location) {
        ...
        function getEmployees(val) {
            $http.post('http://184.168.146.148:88/api/shift/getshiftemployees', val)
                .then(function (response) {
        ...
        $scope.complete = function () {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/task/complete', $scope.completeScope).
                then(function (response) {
                    $scope.model = response.data;
                    console.log($scope.model);
                    swal({
        ...
        $scope.cancelledOrder = function () {
            ...
            console.log($scope.completeScope);
            $scope.message = $http.post('http://184.168.146.148:88/api/task/cancel', $scope.completeScope).
                then(function (response) {
                    $scope.model = response.data;
                    console.log($scope.model);
                    swal({
        ...
        $scope.save = function () {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/task/assignEmployee', $scope.createTask).
                then(function (response) {
                    console.log(response.data);
                    swal({
                        title: 'Saved',
        ...
        $scope.getHtml = function () {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/task/sendemail', $scope.emailFilter).
                then(function (response) {
                    console.log(response.data);
                    $scope.sendingEmail(false);
                });
    ...
    app.controller("viewAssignTask", function ($scope, DTOptionsBuilder, $route, $http, $rootScope, $location) {
        ...
        $http.post('http://184.168.146.148:88/api/task/viewassigntask', 0)
            .then(function (response) {
                $scope.tasks = response.data;
                console.log($scope.tasks);
            });
    ...
    app.controller("viewCompletedTask", function ($scope, DTOptionsBuilder, $route, $http, $rootScope, $location) {
        ...
        $http.post('http://184.168.146.148:88/api/task/viewcompletedtask', 0)
            .then(function (response) {
                $scope.tasks = response.data;
                console.log($scope.tasks);
            });
    ...
    app.controller("viewCancelledTask", function ($scope, DTOptionsBuilder, $route, $http, $rootScope, $location) {
        ...
        $http.post('http://184.168.146.148:88/api/task/viewcancelledtask', 0)
            .then(function (response) {
                $scope.tasks = response.data;
                console.log($scope.tasks);
            });
