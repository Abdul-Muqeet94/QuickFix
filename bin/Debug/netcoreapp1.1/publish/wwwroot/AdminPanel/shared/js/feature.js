(function () {
    ...
    app.controller("addFeature", function ($scope, $http, $log,$location) {
            ...
            $scope.message = $http.post('http://184.168.146.148:88/api/feature/create/', $scope.feature).
 ...
 app.controller("updateFeature", function ($scope, $http, $log,$rootScope,$location) {
     ...
     $scope.message = $http.post('http://184.168.146.148:88/api/feature/view/', $rootScope.featureId).
            then(function (response) {
            ...
            $scope.update=function(){
                 $scope.message = $http.post('http://184.168.146.148:88/api/feature/edit/', $scope.feature).
            then(function (response) {
