...
app.controller("cshiftController", function ($scope, $http, $rootScope,$location) {
    ...
    $scope.addShift = function () {
        ...
        $scope.message = $http.post('http://184.168.146.148:88/api/shift/create/', $scope.shift).
...
app.controller("vshiftController", function ($scope, $http,$route, $rootScope, $location) {
    ...
    $scope.message = $http.post('http://184.168.146.148:88/api/shift/view/', 0).
        then(function (response) {
    ...
    $scope.delete = function (id) {
        $scope.message = $http.post('http://184.168.146.148:88/api/shift/delete/', id).
            then(function (response) {
                $route.reload();
    ...
    $scope.update = function (id) {
        ...
        // $scope.message = $http.post('http://184.168.146.148:88/api/shift/view',id).
        //       then(function (response){
...
app.controller("updateShiftController", function ($scope, $http, $rootScope, $location) {
    ...
    $scope.updateShift = function () {
        ...
        console.log($scope.shifts);
        $scope.message = $http.post('http://184.168.146.148:88/api/shift/edit/', $scope.shifts).
            then(function (response) {
                console.log(response.data);
                swal({
                    title: 'Saved',
