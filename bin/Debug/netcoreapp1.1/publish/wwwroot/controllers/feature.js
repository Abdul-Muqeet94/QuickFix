(function() {
    ...
    app.directive('myGoogleAutocomplete', function() {
        return {
            ...
            template: '<input class="form-control" type="text" style="z-index: 100000;" autocomplete="o' +
                'n">',
            link: function($scope, element, attrs, model) {
                ...
                var autocomplete = new google
                    .maps
                    .places
                    .Autocomplete(element[0], googleOptions);
                ...
                google
                    ...
                    .addListener(autocomplete, 'place_changed', function() {
                        ...
                        $scope.$apply(function() {
                            ...
                            if (!place.geometry) {
                                // User entered the name of a Place that was not suggested and pressed the Enter
                                // key, or the Place Details request failed.
                            ...
                            $scope.googleModel.latitude = place
                                .geometry
                                .location
                                .lat();
                            $scope.googleModel.longitude = place
                                .geometry
                                .location
                                .lng();
    ...
    app.controller("featureController", function($scope, $http, $rootScope, close, ModalService, NgMap) {
		...
		$scope._features.fea= $rootScope.service.feature;
        ...
        $scope
            .$watch("date", function(newValue, oldValue) {
                if (oldValue != newValue) {
                    $scope.shiftFilter.name = $scope._name;
                    $scope.shiftFilter.date = newValue;

                    console.log($scope.shiftFilter);
                    $scope.message = $http
                        .post('http://184.168.146.148:88/api/shift/getshiftfortask', $scope.shiftFilter)
                        .then(function(response) {
        ...
        $scope.onSelect = function(val) {
            NgMap
                .getMap()
                .then(function(map) { //Create the instance of map
        ...
        $scope.getLoc = function(e) {
            ...
            $scope.message = $http
                .get('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + $scope.lati + ',' + $scope.long + '&sensor=true')
                .then(function(response) {
                    console.log(response.data.results[0].formatted_address);
        ...
        $scope.message = $http
            .post('http://184.168.146.148:88/api/service/view/', $rootScope.permService)
            .then(function(response) {
                ...
                $scope.counter = 0;
                $rootScope.task.callUpCharges = 100;
                ...
                $scope.a2 = [];
                $scope.a3 = [];
                $scope._name = $rootScope.service.name;
                // if ($rootScope.service.name == 'AC Service & Repair') {
                //     console.log($rootScope.permService);
                //     $scope
                //         .a1
                //         .push($scope.service.feature[0]);
                //     $scope
                //         .a1
                //         .push($scope.service.feature[1]);

                //     $scope
                //         .a2
                //         .push($scope.service.feature[2]);
                //     $scope
                //         .a2
                //         .push($scope.service.feature[3]);
                //     $scope
                //         .a2
                //         .push($scope.service.feature[4]);
                //     $scope
                //         .a2
                //         .push($scope.service.feature[5]);

                //     $scope
                //         .a3
                //         .push($scope.service.feature[6]);
                //     $scope
                //         .a3
                //         .push($scope.service.feature[7]);
                //     $scope
                //         .a3
                //         .push($scope.service.feature[8]);
                //     $scope
                //         .a3
                //         .push($scope.service.feature[9]);
                //     $scope
                //         .a3
                //         .push($scope.service.feature[10]);
                // }
            ...
            if ($rootScope.service.feature == 0) {
                ...
                if ($rootScope.service.feature.indexOf(id) == -1) {
                    ...
                    $rootScope
                        .service
                        .feature
                        .splice($rootScope.service.feature.indexOf(id), 1);
                }
            }
        }
            ...
            if ($scope.counter == 4) {
                ...
                if (file != null) {
                    ...
                    reader.onload = function(e) {
                        ...
                        console.log($rootScope.task);
                        $scope.message = $http
                            .post('http://184.168.146.148:88/api/task/create/', $scope.task)
                            .then(function(response) {
